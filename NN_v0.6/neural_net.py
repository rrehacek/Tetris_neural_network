...
class NeuralNetwork():
    ...
    def forward_activation_function(self):
        ...
        self.out_left = 1 if in_left > 0.2 or in_left < -0.2 else 0
        self.out_down = 1 if  in_down > 0.2 or in_down < -0.2 else 0
        self.out_right = 1 if in_right > 0.2 or in_right < -0.2 else 0
        self.out_rotate = 1 if in_rotate > 0.2 or in_rotate < -0.2 else 0
