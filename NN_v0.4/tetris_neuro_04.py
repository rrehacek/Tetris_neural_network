...
#Save results of all generation
list_of_all_generations = []
...
for generation in range(number_of_generations):
    ...
    list_of_all_generations.append(list_of_neural_nets)
    ...
    #Introduce mutation
    for agent in list_of_neural_nets:
    ...
    #Introduce crossover
    #For all agents from second half of list
